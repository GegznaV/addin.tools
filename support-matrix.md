...
- [`is_rmd_visual_mode()`](https://gegznav.github.io/addin.tools/reference/is_visual_editor.md)
  remains as a deprecated wrapper for
  [`is_visual_editor()`](https://gegznav.github.io/addin.tools/reference/is_visual_editor.md).
- Downstream packages should migrate to
  [`is_visual_editor()`](https://gegznav.github.io/addin.tools/reference/is_visual_editor.md)
  and remove the deprecated alias from new code.
- Package API changes should preserve behavior for `first`, `last`, and
  `all` selection modes unless a breaking change is explicitly announced
  in `NEWS.md`.
