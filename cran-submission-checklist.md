...
Confirm there are no portable file-name warnings or unintended top-level
files

Confirm no warnings from deprecated helper aliases are used in package
code
...
Run the revdep smoke check before tagging if downstream packages are in
scope
